...
dataLayer.push({
  ...
  "apollo_event": "Product Removed from Save List",
    "ecommerce": {
        "currency": "<currency>",
        "items": [
            {
        ...
        "save_list_removals": "<save_list_removals>",
        "value": <value>
    }
});
```
...
|save_list_removals|string|Count of times products were removed from a "save for later" list.||||||||
