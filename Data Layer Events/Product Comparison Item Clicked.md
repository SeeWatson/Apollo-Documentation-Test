...
dataLayer.push({
  "event": "select_item",
  "apollo_event": "Product Comparison Item Clicked",
    "ecommerce": {
        ...
        "product_comparison_item_clicks": "<product_comparison_item_clicks>"
    }
});
```
...
|product_comparison_item_clicks|unknown|Count of times that a product item in a product comparison was clicked.||||||||
