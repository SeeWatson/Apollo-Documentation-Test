...
dataLayer.push({
  ...
  "apollo_event": "Product Added to Save List",
    "ecommerce": {
        "currency": "<currency>",
        "items": [
            {
        ...
        "save_list_additions": "<save_list_additions>",
        "value": <value>
    }
});
```
...
|save_list_additions|unknown|Count of times products were added to a "save for later" list.||||||||
