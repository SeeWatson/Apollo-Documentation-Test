...
dataLayer.push({
  "event": "select_item",
  "apollo_event": "Product Sku Selected",
    "ecommerce": {
        ...
        "product_sku_selected": "<product_sku_selected>"
    }
});
```
...
|product_sku_selected|string|Count of times that visitors clicked to select a product SKU.|155, 65588, 987764448|||||||
