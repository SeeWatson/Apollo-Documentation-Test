...
dataLayer.push({
  "event": "view_checkout_step",
  "apollo_event": "Checkout Step Encountered",
    "ecommerce": {
        "coupon": "<coupon>",
        "currency": "<currency>",
        "items": [
...
|method|string|Count of times a user interacted with any of the click events in the checkout.||||||||
|price|number|Type of click event engaged with by the user on the checkout page.|200, 29.99, 50, 0|^[0-9]*(\.[0-9]{1,2})?$||||||
|quantity|integer|Item quantity.|1|||||||
|step_name|string|Count of times that visitors begin engaging with online chat.|Cart Review, Billing Info, Shipping Info, Order Review|||||||
