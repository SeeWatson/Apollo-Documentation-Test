...
dataLayer.push({
  ...
  "apollo_event": "Product Removed from Wishlist",
    "ecommerce": {
        "currency": "<currency>",
        ...
        "value": <value>,
        "wishlist_removals": "<wishlist_removals>"
    }
});
```
...
|quantity|integer|Count of product units associated with wishlist removals.|1, 2, 3, 4, 5||||1|||
|value|number|The monetary value of the event.|7.77, 239.55, 659|||||||
|wishlist_removals|string|Count of times that visitors removed wishlists.||||||||
