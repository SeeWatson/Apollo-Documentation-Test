...
dataLayer.push({
  ...
  "apollo_event": "Product Added to Comparison",
    "ecommerce": {
        "currency": "<currency>",
        "items": [
            {
                ...
                "discount": <discount>,
                "index": <index>,
                "item_added_to_comparison": "<item_added_to_comparison>",
...
|item_added_to_comparison|string|Count of times that products were added to comparisons.|all items, 3 of 5, 2 of 4|||||||
