...
dataLayer.push({
  ...
  "apollo_event": "Product Removed from Registry",
    "ecommerce": {
        "currency": "<currency>",
        "gift_registry_removals": "<gift_registry_removals>",
...
|gift_registry_removals|unknown|Count of times visitors removed products from a gift registry.||||||||
...
|price|string|Amount of money associated with products removed from gift registries.|200, 29.99, 50, 0|^[0-9]*(\.[0-9]{1,2})?$||||||
