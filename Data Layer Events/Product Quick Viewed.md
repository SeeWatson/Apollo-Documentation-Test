...
dataLayer.push({
  "event": "view_item",
  "apollo_event": "Product Quick Viewed",
    "ecommerce": {
        "currency": "<currency>",
        "items": [
            {
        ...
        "product_quick_views": "<product_quick_views>",
        "value": <value>
    }
});
```
...
|product_quick_views|unknown|Count of times the user views a quick view product page.||||||||
