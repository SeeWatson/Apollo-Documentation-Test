...
dataLayer.push({
  "event": "select_item",
  "apollo_event": "Wishlist Item Clicked",
    "ecommerce": {
        ...
        "wishlist_item_clicks": "<wishlist_item_clicks>"
    }
});
```
...
|wishlist_item_clicks|unknown|Count of times that items in wishlists were clicked.||||||||
