...
|count_location_impressions|boolean|Count of times that visitors encountered form submission failures.|TRUE|||||||
...
|index|integer|Captures the form error code or message associated with form errors.|1, 2, 3, 4, 5||||0|||
