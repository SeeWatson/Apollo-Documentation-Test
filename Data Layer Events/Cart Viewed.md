...
|item_back_ordered|boolean|Name of the promotional offer presented to the user in the shopping cart|TRUE, FALSE|||||||
...
|item_out_of_stock|integer|Captures the associated product line with a product||||||||
|item_price_hidden_in_cart|integer|Captures the associated price tier with a product||||||||
